...
// 1. sat = (max-min);
float calcSaturation_A( const float r, const float g, const float b ) {
...
float calcSaturation_B( const float r, const float g, const float b ) {
    float v = fmax( fmax( r, g ), b );
...
float calcSaturation_C( const float r, const float g, const float b ) {
    float v = fmax( fmax( r, g ), b );
...
float calcSaturation_D( const float r, const float g, const float b ) {
    float v = fmax( fmax( r, g ), b );
